...
var safekey = builder.Configuration["Jwt:Key"];

if (string.IsNullOrEmpty(safekey) || safekey.Length < 32)
{
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(safekey))
        };
    });
